...
числа. Проценты смешения лежат здесь: ими пользуются и проверка контраста
(checks/a11y.py), и тона контрастной секции (palette.contrast_tones), а две
копии одного процента рано или поздно разъезжаются.
...
# Доли ink в производных тонах — копия из @theme в css/source.css.
SURFACE_MIX = 0.05
LINE_MIX = 0.14
MUTED_MIX = 0.72
