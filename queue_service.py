...
# Именно список: replied_interested появится в разделе 7, и хук должен принять
# его строкой здесь, а не правкой условия в трёх хендлерах.
STOP_LEAD_STATUSES = ("replied", "sold", "refused", "rejected")
